...
#### [1. Понятие архитектуры ПО: монолит, SOA, микросервисы](#soa)
#### [2. Основные принципы микросервисной архитектуры](#_14)
#### [3. Плюсы и минусы микросервисов](#_16)
#### [4. Ключевые паттерны: API Gateway, Service Discovery, Event-Driven Architecture](#api-gateway-service-discovery-event-driven-architecture)
